...
(function () {
  ...
  var ITEMS = {
    ...
    'coffre':         ['coffre',  '#8B5A2B', '#B37C46', '#5C3A1B', 'COFFRE'],
    'banniere':       ['banniere','#C4362B', '#E06A5F', '#8E2419', 'BANNIÈRE'],
    'armure':         ['armure',  '#C4C4C4', '#E8E8E8', '#8F8F8F', 'ARMURE'],
    'armure-nautile': ['armure',  '#3EC4BC', '#ADF5F0', '#2E9E97', 'ARMURE DE NAUTILE'],
